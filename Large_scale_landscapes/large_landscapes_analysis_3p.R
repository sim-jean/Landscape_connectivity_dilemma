...
# 2. Analyse them with the routine of 3 years or 5 years, unclear as of yet
...
for(number in 1:20){
  list_landscape[[number]] = readMM(paste0(working_path, '/large_land/input_/landscape_',1,'.mtx'))
}

if(!(file.exists(paste0(working_path,'large_land/output_/result_3peat_0.mtx')))){
  ...
  for(const_ in as.character(seq(0,100,10))){
    ...
    writeMM(to_save, paste0(working_path, 'large_land/output_/result_3peat_',const_, '.mtx'))
  }
